...
NO_TEMPERATURE_MODELS = {
    ...
    *GEMINI_THINKING_LEVEL_MODELS,
    ...
    # Claude 5 generation: extended thinking is on by default and the API
    # rejects any explicit temperature value (confirmed via direct testing -
    # these model names post-date this repo's original release).
    "claude-sonnet-5",
    "claude-opus-5",
    "claude-fable-5",
}
