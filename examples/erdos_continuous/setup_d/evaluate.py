"""Evaluator for Setup D (one rung of the multi-resolution ladder)."""
...
def adapted_validate(run_output: Tuple[np.ndarray, float, int]) -> Tuple[bool, Optional[str]]:
    if not isinstance(run_output, (tuple, list)) or len(run_output) != 3:
        return False, "Expected (h, c_max, n) tuple from run_setup_d."
...
def aggregate_metrics(results) -> Dict[str, Any]:
    ...
    metrics = {
        ...
        "public": {
            ...
            "rung_n_steps_env": os.environ.get("ERDOS_D_N_STEPS", "600"),
        },
        "private": {},
    }
    return metrics
...
def main(program_path: str, results_dir: str):
    ...
    metrics, correct, error_msg = run_shinka_eval(
        ...
        experiment_fn_name="run_setup_d",
        num_runs=1,
